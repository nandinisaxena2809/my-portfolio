...
const projects = [
  ...
  {
    title: "Weather App",
    description: "Real-time weather application with city autocomplete, geocoding, and 5-day forecasts. Features a clean backend architecture, optimized API handling, and a glassmorphism UI with animated weather states.",
    tech: ["React", "TypeScript", "Tailwind CSS", "Framer Motion", "Node.js", "Express", "OpenWeather API"],
    gradient: "from-sky-400 to-indigo-500",
    emoji: "⛅",
    github: "https://github.com/nandinisaxena2809/weather-app",
  },
  {
